...
function setup() {
  ...
  world = engine.world;
   ...
   b1 = new Block(400,245,40,40);
   b2 = new Block(430,245,40,40);
   b3 = new Block(460,245,40,40);
   b4 = new Block(490,245,40,40);
   b5 = new Block(520,245,40,40);
   b6 = new Block(550,245,40,40);
   b7 = new Block(580,245,40,40);
   ...
   a14 = new Block(960,165,40,40);
   a15 = new Block(960,165,40,40);
...
function draw(){
  ...
  stroke(0);
  fill(200);
  text("Drag the circle to destroy the blocks");
}
